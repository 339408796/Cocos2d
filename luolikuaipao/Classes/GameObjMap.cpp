...
void GameObjMap::bg1change(CCNode *pSender)
{
	...
	CCActionInterval *moveBy=CCMoveBy::create(20,ccp(-960,0));
	bg->runAction(CCSequence::create(moveBy,CCCallFuncN::create(this,callfuncN_selector(GameObjMap::bg1change)),NULL));
	for(int i = 0;i < 5;i ++){
...
void GameObjMap::bg2change(CCNode *pSender)
{
	...
	bg->setPosition(ccp(480,320));
	CCActionInterval *moveBy=CCMoveBy::create(20,ccp(-960,0));
	bg->runAction(CCSequence::create(moveBy,CCCallFuncN::create(this,callfuncN_selector(GameObjMap::bg2change)),NULL));
	for(int i = 0;i < 5;i ++){
